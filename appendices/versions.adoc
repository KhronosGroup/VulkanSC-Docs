...
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VKSC_VERSION_1_0',desc='Vulkan SC version 1.0',type='feature',anchor='versions-sc-1.0']
--
Vulkan SC Version 1.0 is a variant of the Vulkan 1.2 API that is tailored
for safety-critical use cases.

include::{generated}/interfaces/VKSC_VERSION_1_0.adoc[]
--
endif::isrefpage[]
...
// only include the base/compute/graphics version 1.x section if the
// corresponding merged version 1.x section is not included
...
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_BASE_VERSION_1_4',desc='Vulkan Base version 1.4',type='feature',anchor='versions-base-1.4',xrefs='VK_BASE_VERSION_1_0 VK_BASE_VERSION_1_1 VK_BASE_VERSION_1_2 VK_BASE_VERSION_1_3']
--
Vulkan Base Version 1.4 is a subset of the Vulkan 1.4 API.

include::{generated}/interfaces/VK_BASE_VERSION_1_1.adoc[]
--
endif::isrefpage[]
...
include::{generated}/interfaces/VK_BASE_VERSION_1_4.adoc[]
...
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_BASE_VERSION_1_3',desc='Vulkan Base version 1.3',type='feature',anchor='versions-base-1.3',xrefs='VK_BASE_VERSION_1_0 VK_BASE_VERSION_1_1 VK_BASE_VERSION_1_2 VK_BASE_VERSION_1_4']
--
Vulkan Base Version 1.3 is a subset of the Vulkan 1.3 API.
...
include::{generated}/interfaces/VK_BASE_VERSION_1_3.adoc[]
...
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_BASE_VERSION_1_2',desc='Vulkan Base version 1.2',type='feature',anchor='versions-base-1.2',xrefs='VK_BASE_VERSION_1_0 VK_BASE_VERSION_1_1 VK_BASE_VERSION_1_3 VK_BASE_VERSION_1_4']
--
Vulkan Base Version 1.2 is a subset of the Vulkan 1.2 API.

include::{generated}/interfaces/VK_BASE_VERSION_1_2.adoc[]
--
endif::isrefpage[]
...
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_BASE_VERSION_1_1',desc='Vulkan Base version 1.1',type='feature',anchor='versions-base-1.1',xrefs='VK_BASE_VERSION_1_0 VK_BASE_VERSION_1_2 VK_BASE_VERSION_1_3 VK_BASE_VERSION_1_4']
--
Vulkan Base Version 1.1 is a subset of the Vulkan 1.1 API.
...
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_BASE_VERSION_1_0',desc='Vulkan Base version 1.0',type='feature',anchor='versions-base-1.0',xrefs='VK_BASE_VERSION_1_1 VK_BASE_VERSION_1_2 VK_BASE_VERSION_1_3 VK_BASE_VERSION_1_4']
--
Vulkan Base Version 1.0 is a subset of the initial release of the Vulkan 1.0
API.

include::{generated}/interfaces/VK_BASE_VERSION_1_0.adoc[]
--
endif::isrefpage[]

// This is the spec-specific form of the section
Vulkan Base Version 1.0 is a subset the initial release of the Vulkan 1.0
API.
...
ifndef::VK_VERSION_1_4[]
[[versions-compute-1.4]]
== Version Compute 1.4

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_COMPUTE_VERSION_1_4',desc='Vulkan Compute version 1.4',type='feature',anchor='versions-compute-1.4',xrefs='VK_COMPUTE_VERSION_1_0 VK_COMPUTE_VERSION_1_1 VK_COMPUTE_VERSION_1_2 VK_COMPUTE_VERSION_1_3']
--
Vulkan Compute Version 1.4 is a subset of the Vulkan 1.4 API.

include::{generated}/interfaces/VK_COMPUTE_VERSION_1_4.adoc[]
--
endif::isrefpage[]
...
ifndef::VK_VERSION_1_3[]
[[versions-compute-1.3]]
== Version Compute 1.3

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_COMPUTE_VERSION_1_3',desc='Vulkan Compute version 1.3',type='feature',anchor='versions-compute-1.3',xrefs='VK_COMPUTE_VERSION_1_0 VK_COMPUTE_VERSION_1_1 VK_COMPUTE_VERSION_1_2 VK_COMPUTE_VERSION_1_4']
--
Vulkan Compute Version 1.3 is a subset of the Vulkan 1.3 API.

include::{generated}/interfaces/VK_COMPUTE_VERSION_1_3.adoc[]
--
endif::isrefpage[]
...
ifdef::VK_COMPUTE_VERSION_1_2[]
ifndef::VK_VERSION_1_2[]
[[versions-compute-1.2]]
== Version Compute 1.2

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_COMPUTE_VERSION_1_2',desc='Vulkan Compute version 1.2',type='feature',anchor='versions-compute-1.2',xrefs='VK_COMPUTE_VERSION_1_0 VK_COMPUTE_VERSION_1_1 VK_COMPUTE_VERSION_1_3 VK_COMPUTE_VERSION_1_4']
--
Vulkan Compute Version 1.2 is a subset of the Vulkan 1.2 API.

include::{generated}/interfaces/VK_COMPUTE_VERSION_1_2.adoc[]
--
endif::isrefpage[]
...
[[versions-compute-1.1]]
== Version Compute 1.1

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_COMPUTE_VERSION_1_1',desc='Vulkan Compute version 1.1',type='feature',anchor='versions-compute-1.1',xrefs='VK_COMPUTE_VERSION_1_0 VK_COMPUTE_VERSION_1_2 VK_COMPUTE_VERSION_1_3 VK_COMPUTE_VERSION_1_4']
--
Vulkan Compute Version 1.1 is a subset of the Vulkan 1.1 API.

include::{generated}/interfaces/VK_COMPUTE_VERSION_1_1.adoc[]
--
endif::isrefpage[]
...
ifndef::VK_VERSION_1_0[]
[[versions-compute-1.0]]
== Version Compute 1.0

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_COMPUTE_VERSION_1_0',desc='Vulkan Compute version 1.0',type='feature',anchor='versions-compute-1.0',xrefs='VK_COMPUTE_VERSION_1_1 VK_COMPUTE_VERSION_1_2 VK_COMPUTE_VERSION_1_3 VK_COMPUTE_VERSION_1_4']
--
Vulkan Compute Version 1.0 is a subset of the initial release of the Vulkan
1.0 API.

include::{generated}/interfaces/VK_COMPUTE_VERSION_1_0.adoc[]
--
endif::isrefpage[]
...
ifndef::VK_VERSION_1_4[]
[[versions-graphics-1.4]]
== Version Graphics 1.4

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_GRAPHICS_VERSION_1_4',desc='Vulkan Graphics version 1.4',type='feature',anchor='versions-graphics-1.4',xrefs='VK_GRAPHICS_VERSION_1_0 VK_GRAPHICS_VERSION_1_1 VK_GRAPHICS_VERSION_1_2 VK_GRAPHICS_VERSION_1_3']
--
Vulkan Graphics Version 1.4 is a subset of the Vulkan 1.4 API.

include::{generated}/interfaces/VK_GRAPHICS_VERSION_1_4.adoc[]
--
endif::isrefpage[]
...
ifndef::VK_VERSION_1_3[]
[[versions-graphics-1.3]]
== Version Graphics 1.3

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_GRAPHICS_VERSION_1_3',desc='Vulkan Graphics version 1.3',type='feature',anchor='versions-graphics-1.3',xrefs='VK_GRAPHICS_VERSION_1_0 VK_GRAPHICS_VERSION_1_1 VK_GRAPHICS_VERSION_1_2 VK_GRAPHICS_VERSION_1_4']
--
Vulkan Graphics Version 1.3 is a subset of the Vulkan 1.3 API.

include::{generated}/interfaces/VK_GRAPHICS_VERSION_1_3.adoc[]
--
endif::isrefpage[]
...
ifdef::VK_GRAPHICS_VERSION_1_2[]
ifndef::VK_VERSION_1_2[]
[[versions-graphics-1.2]]
== Version Graphics 1.2

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_GRAPHICS_VERSION_1_2',desc='Vulkan Graphics version 1.2',type='feature',anchor='versions-graphics-1.2',xrefs='VK_GRAPHICS_VERSION_1_0 VK_GRAPHICS_VERSION_1_1 VK_GRAPHICS_VERSION_1_3 VK_GRAPHICS_VERSION_1_4']
--
Vulkan Graphics Version 1.2 is a subset of the Vulkan 1.2 API.

include::{generated}/interfaces/VK_GRAPHICS_VERSION_1_2.adoc[]
--
endif::isrefpage[]
...
ifndef::VK_VERSION_1_1[]
[[versions-graphics-1.1]]
== Version Graphics 1.1

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_GRAPHICS_VERSION_1_1',desc='Vulkan Graphics version 1.1',type='feature',anchor='versions-graphics-1.1',xrefs='VK_GRAPHICS_VERSION_1_0 VK_GRAPHICS_VERSION_1_2 VK_GRAPHICS_VERSION_1_3 VK_GRAPHICS_VERSION_1_4']
--
Vulkan Graphics Version 1.1 is a subset of the Vulkan 1.1 API.

include::{generated}/interfaces/VK_GRAPHICS_VERSION_1_1.adoc[]
--
endif::isrefpage[]
...
endif::VK_GRAPHICS_VERSION_1_1[]

ifdef::VK_GRAPHICS_VERSION_1_0[]
ifndef::VK_VERSION_1_0[]
[[versions-graphics-1.0]]
== Version Graphics 1.0

// Unfortunately we cannot include titles in an open refpage block, so this
// is a refpage-specific alternate form of the section.
ifdef::isrefpage[]
[open,refpage='VK_GRAPHICS_VERSION_1_0',desc='Vulkan Graphics version 1.0',type='feature',anchor='versions-graphics-1.0',xrefs='VK_GRAPHICS_VERSION_1_1 VK_GRAPHICS_VERSION_1_2 VK_GRAPHICS_VERSION_1_3 VK_GRAPHICS_VERSION_1_4']
--
Vulkan Graphics Version 1.0 is a subset of the initial release of the Vulkan
1.0 API.

include::{generated}/interfaces/VK_GRAPHICS_VERSION_1_0.adoc[]
--
endif::isrefpage[]
