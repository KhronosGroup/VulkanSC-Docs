...
ifdef::VK_EXT_nested_command_buffer[]
  ...
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09588]]
    If pname:pRenderingInfo->pDepthAttachment is not `NULL` and
    pname:pRenderingInfo->pDepthAttachment->imageView is not
    dlink:VK_NULL_HANDLE, pname:pRenderingInfo->pDepthAttachment->imageView
    must: be in the layout specified by
    pname:pRenderingInfo->pDepthAttachment->imageLayout
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09589]]
    If pname:pRenderingInfo->pDepthAttachment is not `NULL`,
    pname:pRenderingInfo->pDepthAttachment->imageView is not
    dlink:VK_NULL_HANDLE,
    pname:pRenderingInfo->pDepthAttachment->imageResolveMode is not
    ename:VK_RESOLVE_MODE_NONE, and
    pname:pRenderingInfo->pDepthAttachment->resolveImageView is not
    dlink:VK_NULL_HANDLE,
    pname:pRenderingInfo->pDepthAttachment->resolveImageView must: be in the
    layout specified by
    pname:pRenderingInfo->pDepthAttachment->resolveImageLayout
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09590]]
    If pname:pRenderingInfo->pStencilAttachment is not `NULL` and
    pname:pRenderingInfo->pStencilAttachment->imageView is not
    dlink:VK_NULL_HANDLE,
    pname:pRenderingInfo->pStencilAttachment->imageView must: be in the
    layout specified by
    pname:pRenderingInfo->pStencilAttachment->imageLayout
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09591]]
    If pname:pRenderingInfo->pStencilAttachment is not `NULL`,
    pname:pRenderingInfo->pStencilAttachment->imageView is not
    dlink:VK_NULL_HANDLE,
    pname:pRenderingInfo->pStencilAttachment->imageResolveMode is not
    ename:VK_RESOLVE_MODE_NONE, and
    pname:pRenderingInfo->pStencilAttachment->resolveImageView is not
    dlink:VK_NULL_HANDLE,
    pname:pRenderingInfo->pStencilAttachment->resolveImageView must: be in
    the layout specified by
    pname:pRenderingInfo->pStencilAttachment->resolveImageLayout
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09592]]
    For any element of pname:pRenderingInfo->pColorAttachments, if
    pname:imageView is not dlink:VK_NULL_HANDLE, that image view must: be in
    the layout specified by pname:imageLayout
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09593]]
    For any element of pname:pRenderingInfo->pColorAttachments, if
ifdef::VK_ANDROID_external_format_resolve[]
    either pname:imageResolveMode is
    ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID, or
endif::VK_ANDROID_external_format_resolve[]
    pname:imageView is not dlink:VK_NULL_HANDLE and pname:resolveMode is not
    ename:VK_RESOLVE_MODE_NONE, and pname:resolveImageView is not
    dlink:VK_NULL_HANDLE, pname:resolveImageView must: be in the layout
    specified by pname:resolveImageLayout
****
...
ifdef::VK_VERSION_1_1,VK_KHR_device_group[]
  ...
  * [[VUID-VkRenderingInfo-colorAttachmentCount-09476]]
    If pname:colorAttachmentCount is not `0` and there is an element of
    pname:pColorAttachments with
ifdef::VK_ANDROID_external_format_resolve[]
    either its pname:resolveMode member set to
    ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID, or
endif::VK_ANDROID_external_format_resolve[]
    its pname:imageView member not dlink:VK_NULL_HANDLE, and its
    pname:resolveMode member not set to ename:VK_RESOLVE_MODE_NONE, the
    pname:resolveImageView member of that element of pname:pColorAttachments
  ...
  * [[VUID-VkRenderingInfo-pDepthAttachment-09477]]
    ...
    pname:pDepthAttachment->resolveImageView must: have been created with
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT
  ...
  * [[VUID-VkRenderingInfo-pStencilAttachment-09478]]
    ...
    pname:pStencilAttachment->resolveImageView must: have been created with
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT
...
ifdef::VK_ARM_render_pass_striped[]
  ...
  * [[VUID-VkRenderingInfo-colorAttachmentCount-09479]]
    If pname:colorAttachmentCount is not `0` and the pname:imageView member
    of an element of pname:pColorAttachments is not dlink:VK_NULL_HANDLE,
    that pname:imageView must: have been created with the
...
ifdef::VK_ANDROID_external_format_resolve[]
    ...
    its pname:imageView member not set to dlink:VK_NULL_HANDLE and its
    pname:resolveMode member not set to ename:VK_RESOLVE_MODE_NONE, the
    pname:resolveImageView member of that element of pname:pColorAttachments
  ...
  * [[VUID-VkRenderingInfo-pDepthAttachment-09481]]
    If pname:pDepthAttachment is not `NULL` and
    pname:pDepthAttachment->imageView is not dlink:VK_NULL_HANDLE,
    pname:pDepthAttachment->imageView must: have been created with the
    <<resources-image-views-identity-mappings,identity swizzle>>
  * [[VUID-VkRenderingInfo-pDepthAttachment-09482]]
    ...
    pname:pDepthAttachment->resolveMode is not ename:VK_RESOLVE_MODE_NONE,
    pname:pDepthAttachment->resolveImageView must: have been created with
    the <<resources-image-views-identity-mappings,identity swizzle>>
  * [[VUID-VkRenderingInfo-pStencilAttachment-09483]]
    If pname:pStencilAttachment is not `NULL` and
    pname:pStencilAttachment->imageView is not dlink:VK_NULL_HANDLE,
    pname:pStencilAttachment->imageView must: have been created with the
    <<resources-image-views-identity-mappings,identity swizzle>>
...
ifdef::VK_KHR_fragment_shading_rate[]
  * [[VUID-VkRenderingInfo-imageView-09485]]
    If the pname:imageView member of a
    slink:VkRenderingFragmentShadingRateAttachmentInfoKHR structure included
    in the pname:pNext chain is not dlink:VK_NULL_HANDLE, it must: have been
    created with the <<resources-image-views-identity-mappings,identity
    swizzle>>
endif::VK_KHR_fragment_shading_rate[]
ifdef::VK_EXT_fragment_density_map[]
...
In all such cases, pname:rasterizationSamples must: be a valid
elink:VkSampleCountFlagBits value that is set in
...
ifdef::VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
This does not apply when using ename:VK_ATTACHMENT_LOAD_OP_NONE_KHR.
endif::VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
====
...
include::{generated}/api/enums/VkAttachmentLoadOp.adoc[]
  ...
  * ename:VK_ATTACHMENT_LOAD_OP_DONT_CARE specifies that the previous
    ...
    ename:VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT.
ifdef::VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
  * ename:VK_ATTACHMENT_LOAD_OP_NONE_KHR specifies that the previous
...
ifdef::VK_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_KHR_dynamic_rendering,VK_QCOM_render_pass_store_ops[]
This does not apply when using ename:VK_ATTACHMENT_STORE_OP_NONE.
endif::VK_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_KHR_dynamic_rendering,VK_QCOM_render_pass_store_ops[]
====
...
ifdef::VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-vkCmdBeginRenderPass-initialLayout-09537]]
    ...
    the sname:VkAttachmentReference structures specified when creating the
    render pass specified in the pname:renderPass member of
    pname:pRenderPassBegin is ename:VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ_KHR
    then the corresponding attachment image view of the framebuffer
    specified in the pname:framebuffer member of pname:pRenderPassBegin
    must: have been created with a pname:usage value including either
    ename:VK_IMAGE_USAGE_STORAGE_BIT, or both
...
zero, then pname:perViewRenderAreaCount must: be at least one greater than
...
ifdef::VK_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_QCOM_render_pass_store_ops,VK_KHR_dynamic_rendering[]
...
endif::VK_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_QCOM_render_pass_store_ops,VK_KHR_dynamic_rendering[]
