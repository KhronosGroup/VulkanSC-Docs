...
In this case, the corresponding elements of pname:pPipelines will be
...
pname:pPipelines will be dlink:VK_NULL_HANDLE.
...
include::{generated}/api/protos/vkCreateComputePipelines.adoc[]
  ...
  * pname:pipelineCache is
ifndef::VKSC_VERSION_1_0[]
    either dlink:VK_NULL_HANDLE, indicating that pipeline caching is
    disabled, or to enable caching,
endif::VKSC_VERSION_1_0[]
    the handle of a valid slink:VkPipelineCache object.
...
ifdef::VK_VERSION_1_3[]
    slink:VkPhysicalDeviceProperties::pname:apiVersion is greater than or
    equal to Vulkan 1.3
endif::VK_VERSION_1_3[]
ifdef::VK_VERSION_1_3+VK_KHR_maintenance4[or]
ifdef::VK_KHR_maintenance4[]
    apiext:VK_KHR_maintenance4 is enabled
endif::VK_KHR_maintenance4[]
    pname:layout must: not be accessed outside of the duration of the
...
If the pname:pNext chain includes a slink:VkPipelineCreateFlags2CreateInfo
structure, slink:VkPipelineCreateFlags2CreateInfo::pname:flags from that
structure is used instead of pname:flags from this structure.
...
ifdef::VK_AMDX_shader_enqueue[]
    If the <<features-shaderEnqueue,pname:shaderEnqueue>> feature is not
    enabled,
...
include::{generated}/api/structs/VkPipelineShaderStageCreateInfo.adoc[]
  ...
  * pname:stage is a elink:VkShaderStageFlagBits value specifying a single
    pipeline stage.
  * pname:module is
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library,VK_EXT_shader_module_identifier[]
    optionally
endif::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library,VK_EXT_shader_module_identifier[]
    a slink:VkShaderModule object containing the shader code for this stage.
    The implementation must: not access this object outside of the duration
...
ifndef::VKSC_VERSION_1_0[]
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library[]
...
endif::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library[]
ifndef::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library[]
...
slink:VkPipelineShaderStageModuleIdentifierCreateInfoEXT structure with
...
ifdef::VK_KHR_cooperative_matrix[]
  * [[VUID-VkPipelineShaderStageCreateInfo-module-08987]]
    ...
    <<interfaces-builtin-variables-sgs,effective subgroup size>>.
...
ifdef::VK_NV_cooperative_matrix2[]
  * [[VUID-VkPipelineShaderStageCreateInfo-module-10169]]
    If pname:module uses the code:OpTypeCooperativeMatrixKHR instruction
    with a code:Scope equal to code:Workgroup, then the local workgroup size
    in the X dimension of the pipeline must: be a multiple of the
    <<interfaces-builtin-variables-sgs,effective subgroup size>> and the
    total local workgroup size must: be a power of two multiple of the
    <<interfaces-builtin-variables-sgs,effective subgroup size>> and must:
    be less than or equal to
    <<limits-cooperativeMatrixWorkgroupScopeMaxWorkgroupSize,cooperativeMatrixWorkgroupScopeMaxWorkgroupSize>>
...
[open,refpage='VkPipelineRobustnessCreateInfo',desc='Structure controlling the robustness of a newly created pipeline shader stage',type='structs',alias='VkPipelineRobustnessCreateInfoEXT']
--
The sname:VkPipelineRobustnessCreateInfo structure is defined as:

include::{generated}/api/structs/VkPipelineRobustnessCreateInfo.adoc[]
...
The scope of the effect of sname:VkPipelineRobustnessCreateInfo depends on
which structure's pname:pNext chain it is included in.
...
ifdef::VK_KHR_ray_tracing_pipeline[sname:VkRayTracingPipelineCreateInfoKHR,]
    ...
    sname:VkPipelineRobustnessCreateInfo applies to all accesses through
    this pipeline
  * sname:VkPipelineShaderStageCreateInfo: +
    The robustness behavior described by
    sname:VkPipelineRobustnessCreateInfo applies to all accesses emanating
    from the shader code of this shader stage

If sname:VkPipelineRobustnessCreateInfo is specified for both a pipeline and
a pipeline stage, the sname:VkPipelineRobustnessCreateInfo specified for the
pipeline stage will take precedence.

ifdef::VK_KHR_pipeline_library[]
When sname:VkPipelineRobustnessCreateInfo is specified for a pipeline, it
...
****
  * [[VUID-VkPipelineRobustnessCreateInfo-pipelineRobustness-06926]]
    ...
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DEVICE_DEFAULT
  ...
  * [[VUID-VkPipelineRobustnessCreateInfo-pipelineRobustness-06929]]
    ...
    ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DEVICE_DEFAULT
  * [[VUID-VkPipelineRobustnessCreateInfo-robustImageAccess-06930]]
    ...
    ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS
  * [[VUID-VkPipelineRobustnessCreateInfo-robustBufferAccess2-06931]]
    ...
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2
  ...
  * [[VUID-VkPipelineRobustnessCreateInfo-robustImageAccess2-06934]]
    ...
    is not supported, pname:images must: not be
    ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_2
ifdef::VK_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineRobustnessCreateInfo-storageBuffers-10636]]
    If pname:storageBuffers is
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS or
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2, and
    either the <<features-descriptorBindingStorageBufferUpdateAfterBind,
    pname:descriptorBindingStorageBufferUpdateAfterBind>> feature or the
    <<features-descriptorBindingStorageTexelBufferUpdateAfterBind,
    pname:descriptorBindingStorageTexelBufferUpdateAfterBind>> feature is
    enabled on the device, <<limits-robustBufferAccessUpdateAfterBind,
    pname:robustBufferAccessUpdateAfterBind>> must: be ename:VK_TRUE
  * [[VUID-VkPipelineRobustnessCreateInfo-uniformBuffers-10637]]
    If pname:uniformBuffers is
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS or
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2, and
    either
ifdef::VK_EXT_inline_uniform_block,VK_VERSION_1_3[]
    the <<features-descriptorBindingInlineUniformBlockUpdateAfterBind,
    pname:descriptorBindingInlineUniformBlockUpdateAfterBind>> feature,
endif::VK_EXT_inline_uniform_block,VK_VERSION_1_3[]
    the <<features-descriptorBindingUniformBufferUpdateAfterBind,
    pname:descriptorBindingUniformBufferUpdateAfterBind>> feature, or the
    <<features-descriptorBindingUniformTexelBufferUpdateAfterBind,
    pname:descriptorBindingUniformTexelBufferUpdateAfterBind>> feature is
    enabled on the device, <<limits-robustBufferAccessUpdateAfterBind,
    pname:robustBufferAccessUpdateAfterBind>> must: be ename:VK_TRUE
  * [[VUID-VkPipelineRobustnessCreateInfo-images-10638]]
    If pname:images is
    ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS or
    ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_2, and
    either the <<features-descriptorBindingStorageImageUpdateAfterBind,
    pname:descriptorBindingStorageImageUpdateAfterBind>> feature or the
    <<features-descriptorBindingSampledImageUpdateAfterBind,
    pname:descriptorBindingSampledImageUpdateAfterBind>> feature is enabled
    on the device, <<limits-robustBufferAccessUpdateAfterBind,
    pname:robustBufferAccessUpdateAfterBind>> must: be ename:VK_TRUE
endif::VK_VERSION_1_2,VK_EXT_descriptor_indexing[]
****

include::{generated}/validity/structs/VkPipelineRobustnessCreateInfo.adoc[]
--

[open,refpage='VkPipelineRobustnessBufferBehavior',desc='Enum controlling the robustness of buffer accesses in a pipeline stage',type='enums',alias='VkPipelineRobustnessBufferBehaviorEXT']
--
Possible values of the pname:storageBuffers, pname:uniformBuffers, and
pname:vertexInputs members of slink:VkPipelineRobustnessCreateInfo are:

include::{generated}/api/enums/VkPipelineRobustnessBufferBehavior.adoc[]
...
include::{generated}/api/enums/VkPipelineRobustnessBufferBehaviorEXT.adoc[]
  ...
  * ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DEVICE_DEFAULT specifies
    that <<shaders-execution-memory-access-bounds, out of bounds>> buffer
    accesses follow the behavior of robust buffer access features enabled
    for the device.
  * ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DISABLED specifies that
    buffer accesses must: not be <<shaders-execution-memory-access-bounds,
    out of bounds>>.
  * ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS
    specifies that buffer accesses conform to
    <<shaders-robust-buffer-access>> guarantees.
  * ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2
    specifies that buffer accesses conform to
    <<shaders-robust-buffer-access2>> guarantees.
--

[open,refpage='VkPipelineRobustnessImageBehavior',desc='Enum controlling the robustness of image accesses in a pipeline stage',type='enums',alias='VkPipelineRobustnessImageBehaviorEXT']
--
Possible values of the pname:images member of
slink:VkPipelineRobustnessCreateInfo are:

include::{generated}/api/enums/VkPipelineRobustnessImageBehavior.adoc[]
...
include::{generated}/api/enums/VkPipelineRobustnessImageBehaviorEXT.adoc[]
  ...
  * ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DEVICE_DEFAULT specifies
    that <<shaders-execution-memory-access-bounds, out of bounds>> image
    accesses follow the behavior of robust image access features enabled for
    the device.
  * ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DISABLED specifies that
    image accesses must: not be <<shaders-execution-memory-access-bounds,
    out of bounds>>.
  * ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS
    specifies that image accesses conform to <<shaders-robust-image-access>>
    guarantees.
  * ename:VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_2
    specifies that image accesses conform to
    <<shaders-robust-image-access2>> guarantees.
--
...
****
  ...
  * [[VUID-VkPipelineShaderStageModuleIdentifierCreateInfoEXT-pNext-06851]]
    If this structure is included in a pname:pNext chain of
...
****
  ...
  * [[VUID-VkComputePipelineIndirectBufferInfoNV-deviceAddress-09011]]
    ...
    slink:VkMemoryRequirements2::pname:memoryRequirements.alignment, as
    returned by flink:vkGetPipelineIndirectMemoryRequirementsNV
  ...
  * [[VUID-VkComputePipelineIndirectBufferInfoNV-size-09013]]
    ...
    slink:VkMemoryRequirements2::pname:memoryRequirements.size, as returned
    by flink:vkGetPipelineIndirectMemoryRequirementsNV
...
ifdef::VK_EXT_extended_dynamic_state3[]
    ...
    and either the <<features-alphaToOne, alphaToOne>> feature is not
    enabled or ename:VK_DYNAMIC_STATE_ALPHA_TO_ONE_ENABLE_EXT is set, in
    which case
...
ifdef::VK_VALVE_fragment_density_map_layered[]
  * Inclusion/omission of the
    ename:VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE flag
...
If omitted, pname:stageCount must: be `0` and pname:pStages must: be `NULL`.
...
ifdef::VK_EXT_extended_dynamic_state3[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-TessellationEvaluation-07723]]
    ...
    code:PointMode {ExecutionMode}, and the
    <<features-shaderTessellationAndGeometryPointSize,
    pname:shaderTessellationAndGeometryPointSize>> feature is enabled, a
...
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-TessellationEvaluation-07724]]
    ...
    code:PointMode {ExecutionMode}, and the
    <<features-shaderTessellationAndGeometryPointSize,
    pname:shaderTessellationAndGeometryPointSize>> feature is not enabled, a
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-shaderTessellationAndGeometryPointSize-08776]]
    ...
    uses the code:OutputPoints {ExecutionMode}, and the
    <<features-shaderTessellationAndGeometryPointSize,
    pname:shaderTessellationAndGeometryPointSize>> feature is enabled, a
...
ifdef::VK_EXT_extended_dynamic_state3[]
    ...
    not set, or the <<features-alphaToOne,alphaToOne>> feature is enabled
...
ifdef::VK_NV_coverage_reduction_mode[]
  * [[VUID-VkGraphicsPipelineCreateInfo-coverageReductionMode-02722]]
    If the pipeline requires <<pipelines-graphics-subsets-fragment-output,
    fragment output interface state>>, the <<features-coverageReductionMode,
    pname:coverageReductionMode>> feature is enabled, and
...
ifdef::VK_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
  * [[VUID-VkGraphicsPipelineCreateInfo-lineRasterizationMode-02766]]
    ...
    slink:VkPipelineRasterizationLineStateCreateInfo structure included in
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-stippledLineEnable-02767]]
    ...
    slink:VkPipelineRasterizationLineStateCreateInfo is ename:VK_TRUE, and
    no element of the pname:pDynamicStates member of pname:pDynamicState is
    ename:VK_DYNAMIC_STATE_LINE_STIPPLE, then the pname:lineStippleFactor
    member of slink:VkPipelineRasterizationLineStateCreateInfo must: be in
    the range [eq]#[1,256]#
endif::VK_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
ifdef::VK_AMDX_shader_enqueue[]
  * [[VUID-VkGraphicsPipelineCreateInfo-shaderMeshEnqueue-10187]]
    ...
    not enabled, shaders specified by pname:pStages must: not declare the
    code:ShaderEnqueueAMDX capability
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-10188]]
    If pname:flags does not include
    ename:VK_PIPELINE_CREATE_LIBRARY_BIT_KHR, shaders specified by
    pname:pStages must: not declare the code:ShaderEnqueueAMDX capability
  * [[VUID-VkGraphicsPipelineCreateInfo-pStages-10189]]
    If any shader stages in pname:pStages declare the code:ShaderEnqueueAMDX
    capability, ename:VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX and
    ename:VK_PIPELINE_CREATE_2_LIBRARY_BIT_KHR must: be included in
    pname:flags
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-10190]]
    If ename:VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX is included in
    pname:flags, and the pipeline requires
    <<pipelines-graphics-subsets-pre-rasterization, pre-rasterization shader
    state>>, there must: not be a task or vertex shader specified in
    pname:pStages
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-10191]]
    If ename:VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX is included in
    pname:flags, all elements of
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries must: have been
    created with ename:VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX
endif::VK_AMDX_shader_enqueue[]
ifdef::VK_KHR_ray_tracing_pipeline[]
...
ifdef::VK_VERSION_1_3[]
    the minimum value of slink:VkApplicationInfo::pname:apiVersion used to
    create the slink:VkInstance and pname:apiVersion supported by the
...
ifdef::VK_VERSION_1_3+VK_EXT_extended_dynamic_state2[and]
ifdef::VK_VERSION_1_3[]
    the minimum value of slink:VkApplicationInfo::pname:apiVersion used to
    create the slink:VkInstance and pname:apiVersion supported by the
    physical device is less than Version 1.3
...
ifdef::VK_NV_device_generated_commands[]
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-02877]]
    ...
    <<features-deviceGeneratedCommandsNV,
...
ifdef::VK_EXT_device_generated_commands[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-11001]]
    If the pipeline requires <<pipelines-graphics-subsets-pre-rasterization,
    pre-rasterization shader state>> and pname:flags includes
    ename:VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT, then all stages
    must: not specify code:Xfb execution mode
...
ifdef::VK_VERSION_1_4,VK_EXT_pipeline_protected_access[]
  * [[VUID-VkGraphicsPipelineCreateInfo-pipelineProtectedAccess-07368]]
    ...
    must: not include ename:VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT or
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-07369]]
    ...
    ename:VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT
endif::VK_VERSION_1_4,VK_EXT_pipeline_protected_access[]
ifdef::VK_KHR_fragment_shading_rate[]
...
ifdef::VK_AMDX_shader_enqueue[]
ifdef::VK_EXT_graphics_pipeline_library[and if]
ifndef::VK_EXT_graphics_pipeline_library[If]
    the <<features-shaderMeshEnqueue,pname:shaderMeshEnqueue>> feature is
    not enabled,
endif::VK_AMDX_shader_enqueue[]
    pname:flags must: not include ename:VK_PIPELINE_CREATE_LIBRARY_BIT_KHR
endif::VK_KHR_pipeline_library[]
...
ifndef::VK_AMDX_shader_enqueue[If]
    the pipeline is being created with
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-pLibraries-06613]]
    ...
    ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT, then the
    pname:layout used by each library must: be
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-06616]]
    ...
    not dlink:VK_NULL_HANDLE must: be
    <<glossary-identically-defined,identically defined>> to the element at
    the same index of pname:pSetLayouts used to create the library's
    pname:layout
  * [[VUID-VkGraphicsPipelineCreateInfo-pLibraries-06617]]
    ...
    that are not dlink:VK_NULL_HANDLE must: be
    <<glossary-identically-defined,identically defined>> to the element at
    the same index of pname:pSetLayouts used to create the other library's
    pname:layout
...
ifdef::VK_EXT_extended_dynamic_state3[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-06633]]
    ...
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT,
    pname:pMultisampleState must: be
    <<glossary-identically-defined,identically defined>> to that used to
    create the library
...
ifdef::VK_QCOM_multiview_per_view_viewports[]
  * [[VUID-VkGraphicsPipelineCreateInfo-pDynamicStates-07730]]
    ...
    ename:VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT, and if the
    ...
    element of slink:VkRenderPassMultiviewCreateInfo::pname:pViewMasks must:
    be less than pname:pViewportState->viewportCount
  * [[VUID-VkGraphicsPipelineCreateInfo-pDynamicStates-07731]]
    If the pipeline requires <<pipelines-graphics-subsets-pre-rasterization,
    pre-rasterization shader state>>, and no element of the
    pname:pDynamicStates member of pname:pDynamicState is
    ename:VK_DYNAMIC_STATE_SCISSOR or
    ename:VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT, and if the
    <<features-multiviewPerViewViewports, pname:multiviewPerViewViewports>>
    feature is enabled, then the index of the most significant bit in each
    element of slink:VkRenderPassMultiviewCreateInfo::pname:pViewMasks must:
    be less than pname:pViewportState->scissorCount
...
ifdef::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-09531]]
    ...
    slink:VkRenderingInputAttachmentIndexInfo is included,
    slink:VkRenderingInputAttachmentIndexInfo::pname:colorAttachmentCount
    must: be equal to
    slink:VkPipelineRenderingCreateInfo::pname:colorAttachmentCount
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-09652]]
    ...
    and <<pipelines-graphics-subsets-fragment-output, fragment output
    state>>, the value of pname:renderPass is dlink:VK_NULL_HANDLE, and
    slink:VkRenderingInputAttachmentIndexInfo is not included, the fragment
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-09532]]
    ...
    slink:VkRenderingAttachmentLocationInfo::pname:colorAttachmentCount
    must: be equal to
    slink:VkPipelineRenderingCreateInfo::pname:colorAttachmentCount
endif::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
****
...
ifdef::VK_VALVE_fragment_density_map_layered[]
[open,refpage='VkPipelineFragmentDensityMapLayeredCreateInfoVALVE',desc='Structure specifying layered fragment density map info',type='structs']
--
The sname:VkPipelineFragmentDensityMapLayeredCreateInfoVALVE structure is
defined as:

include::{generated}/api/structs/VkPipelineFragmentDensityMapLayeredCreateInfoVALVE.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:maxFragmentDensityMapLayers is the maximum number of layers which
...
****
  * [[VUID-VkPipelineFragmentDensityMapLayeredCreateInfoVALVE-maxFragmentDensityMapLayers-10825]]
    pname:maxFragmentDensityMapLayers must: be less than or equal to
    <<limits-maxFragmentDensityMapLayers,pname:maxFragmentDensityMapLayers>>
****

include::{generated}/validity/structs/VkPipelineFragmentDensityMapLayeredCreateInfoVALVE.adoc[]
--
endif::VK_VALVE_fragment_density_map_layered[]
...
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5[]
[open,refpage='VkPipelineCreateFlags2CreateInfo',desc='Extended pipeline create flags',type='structs',alias='VkPipelineCreateFlags2CreateInfoKHR']
--
The sname:VkPipelineCreateFlags2CreateInfo structure is defined as:

include::{generated}/api/structs/VkPipelineCreateFlags2CreateInfo.adoc[]
...
include::{generated}/api/structs/VkPipelineCreateFlags2CreateInfoKHR.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:flags is a bitmask of elink:VkPipelineCreateFlagBits2 specifying
...
include::{generated}/validity/structs/VkPipelineCreateFlags2CreateInfo.adoc[]
--

[open,refpage='VkPipelineCreateFlagBits2',desc='Bitmask controlling how a pipeline is created',type='enums',alias='VkPipelineCreateFlagBits2KHR']
--
Bits which can: be set in
slink:VkPipelineCreateFlags2CreateInfo::pname:flags, specifying how a
pipeline is created, are:

include::{generated}/api/enums/VkPipelineCreateFlagBits2.adoc[]
...
// are mirrored in VkPipelineCreateFlagBits2/VkPipelineCreateFlagBits

  * ename:VK_PIPELINE_CREATE_2_DISABLE_OPTIMIZATION_BIT specifies that the
    created pipeline will not be optimized.
    Using this flag may: reduce the time taken to create the pipeline.
  * ename:VK_PIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT specifies that the
  ...
  * ename:VK_PIPELINE_CREATE_2_DERIVATIVE_BIT specifies that the pipeline to
    be created will be a child of a previously created parent pipeline.
ifdef::VK_VERSION_1_1,VK_KHR_device_group[]
ifdef::VK_VERSION_1_1,VK_KHR_multiview[]
  * ename:VK_PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT specifies
    that any shader input variables decorated as code:ViewIndex will be
    assigned values as if they were decorated as code:DeviceIndex.
endif::VK_VERSION_1_1,VK_KHR_multiview[]
  * ename:VK_PIPELINE_CREATE_2_DISPATCH_BASE_BIT specifies that a compute
    pipeline can: be used with flink:vkCmdDispatchBase with a non-zero base
    workgroup.
endif::VK_VERSION_1_1,VK_KHR_device_group[]
...
ifdef::VK_NV_ray_tracing_linear_swept_spheres[]
    ...
    will be skipped during traversal using <<glossary-pipeline-trace-ray,
    pipeline trace ray>> instructions.
  * ename:VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_BUILT_IN_PRIMITIVES_BIT_KHR
    is an alias for
    ename:VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR.
...
ifdef::VK_NV_ray_tracing_linear_swept_spheres[]
  * ename:VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_BIT_NV
...
ifdef::VK_EXT_device_generated_commands[]
  * ename:VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT specifies that the
    pipeline can: be used in a sname:VkIndirectExecutionSetEXT.
endif::VK_EXT_device_generated_commands[]
ifdef::VK_VERSION_1_3,VK_EXT_pipeline_creation_cache_control[]
  * ename:VK_PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT
    ...
    creation, and the slink:VkPipeline will be dlink:VK_NULL_HANDLE.
  * When creating multiple pipelines,
    ename:VK_PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT specifies that
...
ifdef::VK_EXT_fragment_density_map[]
  * ename:VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT
    ...
    attachment.
ifdef::VK_VALVE_fragment_density_map_layered[]
  * ename:VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE
...
ifdef::VK_EXT_attachment_feedback_loop_layout[]
  * ename:VK_PIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT
    ...
    <<renderpass-feedbackloop,feedback loop>> including color attachments.
  * ename:VK_PIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT
    specifies that the pipeline may: be used with an attachment
    <<renderpass-feedbackloop,feedback loop>> including depth-stencil
    attachments.
endif::VK_EXT_attachment_feedback_loop_layout[]
ifdef::VK_EXT_opacity_micromap[]
...
ifdef::VK_VERSION_1_4,VK_EXT_pipeline_protected_access[]
  * ename:VK_PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT specifies that the
    pipeline must: not be bound to a protected command buffer.
  * ename:VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT specifies that the
...
ifdef::VK_AMDX_shader_enqueue[]
  * ename:VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX specifies that the
    pipeline will be used in an <<executiongraphs, execution graph>>
endif::VK_AMDX_shader_enqueue[]
ifdef::VK_ARM_pipeline_opacity_micromap[]
  * ename:VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM specifies
...
It is valid to set both ename:VK_PIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT and
ename:VK_PIPELINE_CREATE_2_DERIVATIVE_BIT.
...
[open,refpage='VkPipelineCreateFlags2',desc='Bitmask of VkPipelineCreateFlagBits2',type='flags',alias='VkPipelineCreateFlags2KHR']
--
include::{generated}/api/flags/VkPipelineCreateFlags2.adoc[]
...
tname:VkPipelineCreateFlags2 is a bitmask type for setting a mask of zero or
more elink:VkPipelineCreateFlagBits2.
--
endif::VK_VERSION_1_4,VK_KHR_maintenance5[]
...
ifdef::VK_VERSION_1_1,VK_KHR_multiview[]
  ...
  * ename:VK_PIPELINE_CREATE_DISPATCH_BASE_BIT specifies that a compute
    pipeline can: be used with flink:vkCmdDispatchBase with a non-zero base
    workgroup.
endif::VK_VERSION_1_1,VK_KHR_device_group[]
ifdef::VK_NV_ray_tracing[]
...
ifdef::VK_VERSION_1_4,VK_EXT_pipeline_protected_access[]
  * ename:VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT specifies that the
    pipeline must: not be bound to a protected command buffer.
  * ename:VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT specifies that the
    pipeline must: not be bound to an unprotected command buffer.
endif::VK_VERSION_1_4,VK_EXT_pipeline_protected_access[]
...
ifdef::VK_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
  * ename:VK_DYNAMIC_STATE_LINE_STIPPLE specifies that the
    pname:lineStippleFactor and pname:lineStipplePattern state in
    slink:VkPipelineRasterizationLineStateCreateInfo will be ignored and
    must: be set dynamically with flink:vkCmdSetLineStipple before any draws
    are performed with a pipeline state with
    slink:VkPipelineRasterizationLineStateCreateInfo member
...
ifdef::VK_EXT_depth_clamp_control[]
  * ename:VK_DYNAMIC_STATE_DEPTH_CLAMP_RANGE_EXT specifies that the
    pname:depthClampMode and pname:pDepthClampRange state in
    slink:VkPipelineViewportDepthClampControlCreateInfoEXT will be ignored
    and must: be set dynamically with flink:vkCmdSetDepthClampRangeEXT
    before any draw call.
...
ifdef::VK_ARM_pipeline_opacity_micromap[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-10392]]
    If the pname:pNext chain includes a
    slink:VkPipelineCreateFlags2CreateInfo structure, pname:flags must: not
    include both
    ename:VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT and
    ename:VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM
endif::VK_ARM_pipeline_opacity_micromap[]
****
ifdef::VKSC_VERSION_1_0[]
ifdef::hidden[]
...
ifdef::VK_KHR_ray_tracing_pipeline+VK_NV_cluster_acceleration_structure[]

[open,refpage='VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV',desc='Structure controlling if cluster acceleration structures are allowed',type='structs']
--
:refpage: VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV

The slink:VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV
structure is defined as:

include::{generated}/api/structs/VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:allowClusterAccelerationStructure controls if cluster acceleration
    structures are allowed in the ray tracing pipeline.

If no cluster acceleration structures are present in the ray tracing
pipeline, pname:allowClusterAccelerationStructure should: not be used to
...
include::{generated}/validity/structs/VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV.adoc[]
--

endif::VK_KHR_ray_tracing_pipeline+VK_NV_cluster_acceleration_structure[]
...
The ename:VkRayTracingShaderGroupTypeKHR enumeration is defined as:
...
include::{generated}/api/enums/VkRayTracingShaderGroupTypeNV.adoc[]
  ...
  * ename:VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR specifies that a
    shader group with a single ename:VK_SHADER_STAGE_RAYGEN_BIT_KHR,
    ename:VK_SHADER_STAGE_MISS_BIT_KHR, or
...
pname:maxPipelineRayPayloadSize is calculated as the maximum size of the
block (in bytes) declared in the code:RayPayloadKHR or
code:IncomingRayPayloadKHR storage classes.
pname:maxPipelineRayHitAttributeSize is calculated as the maximum size of
any block (in bytes) declared in the code:HitAttributeKHR storage class.
...
ifdef::VK_NV_ray_tracing[]
:propertystruct: VkPhysicalDeviceRayTracingPropertiesNV
endif::VK_NV_ray_tracing[]

ifdef::VK_KHR_ray_tracing_pipeline[]
:propertystruct: VkPhysicalDeviceRayTracingPipelinePropertiesKHR
endif::VK_KHR_ray_tracing_pipeline[]

On success, an array of pname:groupCount shader handles will be written to
pname:pData, with each element being of size
slink:{propertystruct}::pname:shaderGroupHandleSize.
...
****
  ...
  * [[VUID-vkGetRayTracingShaderGroupHandlesKHR-dataSize-02420]]
    ...
    [eq]#slink:{propertystruct}::pname:shaderGroupHandleSize {times}
    pname:groupCount#
ifdef::VK_KHR_pipeline_library[]
...
ifdef::VKSC_VERSION_1_0[]
  * pname:pInitialData is a pointer to pipeline cache data that has been
    ...
    If ename:VK_PIPELINE_CACHE_CREATE_USE_APPLICATION_STORAGE_BIT is set in
    pname:flags, pname:pInitialData may: only be accessed by the
    implementation during commands using the slink:VkPipelineCache object.
...
ifdef::VK_KHR_maintenance8[]
  * [[VUID-VkPipelineCacheCreateInfo-maintenance8-10200]]
    ...
    ename:VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR
ifdef::VK_VERSION_1_3,VK_EXT_pipeline_creation_cache_control[]
  * [[VUID-VkPipelineCacheCreateInfo-flags-10201]]
    If pname:flags includes
    ename:VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT, it must: not
    include
    ename:VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR
endif::VK_VERSION_1_3,VK_EXT_pipeline_creation_cache_control[]
...
ifdef::VK_KHR_maintenance8[]
  * ename:VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR
    specifies that when the created slink:VkPipelineCache is used as the
    pname:dstCache parameter of flink:vkMergePipelineCaches, it does not
    need to be <<fundamentals-threadingbehavior,externally synchronized>>.
...
// This text fragment is used multiple times the Pipelines and Debugging chapters.
// Authors must define binary_blob_size prior to inclusion.
ifdef::hidden[]
// tag::binary_blob_header[]
...
include::{generated}/api/structs/VkPipelineCacheHeaderVersionSafetyCriticalOne.adoc[]
  ...
  * pname:validationVersion is a elink:VkPipelineCacheValidationVersion enum
    ...
    pname:validationVersion must: be written as exactly 4 bytes.
...
the two pname:pPipelineCreateInfo->pNext create infos must: produce the same
slink:VkPipelineBinaryKHR contents.
...
Otherwise, pname:pipelineBinaryCount must: be the number of entries in the
pname:pPipelineBinaries array, and on return from
...
is written to pname:pPipelineBinaryKey, regardless of whether
pname:pPipelineBinaryData is `NULL` or not.
...
ifdef::VK_VERSION_1_4,VK_EXT_pipeline_protected_access[]
  * [[VUID-VkPipelineLibraryCreateInfoKHR-pipeline-07404]]
    ...
    ename:VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT, every element of
    pname:pLibraries must: have been created with
    ename:VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT
  ...
  * [[VUID-VkPipelineLibraryCreateInfoKHR-pipeline-07406]]
    If pname:pipeline is being created with
    ename:VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT, every element of
    pname:pLibraries must: have been created with
    ename:VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT
...
ifdef::VK_ARM_data_graph[]
  * [[VUID-vkCmdBindPipeline-pipelineBindPoint-09910]]
    If pname:pipelineBindPoint is
    ename:VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM, the sname:VkCommandPool
    that pname:commandBuffer was allocated from must: have been created for
    a queue family that supports ename:VK_QUEUE_DATA_GRAPH_BIT_ARM
  * [[VUID-vkCmdBindPipeline-pipelineBindPoint-09911]]
    If pname:pipelineBindPoint is
    ename:VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM, pname:pipeline must: be a
    <<graphs-pipelines,data graph pipeline>>
  * [[VUID-vkCmdBindPipeline-pipeline-09912]]
    If pname:pipeline is a <<graphs-pipelines,data graph pipeline>> and the
    slink:VkDataGraphPipelineCreateInfoARM structure used to create it had a
    slink:VkDataGraphProcessingEngineCreateInfoARM structure in its
    pname:pNext chain that specified any foreign data processing engines,
    then the command pool from which pname:commandBuffer was allocated must:
    have been created with a slink:VkCommandPoolCreateInfo structure that
    had a slink:VkDataGraphProcessingEngineCreateInfoARM structure
    specifying a superset of the foreign data graph processing engines
    specified at pipeline creation time in its pname:pNext chain
  * [[VUID-vkCmdBindPipeline-pipeline-09913]]
    If pname:pipeline is a <<graphs-pipelines,data graph pipeline>> and the
    slink:VkDataGraphPipelineCreateInfoARM structure used to create it did
    not have a slink:VkDataGraphProcessingEngineCreateInfoARM structure in
    its pname:pNext chain, then the command pool from which
    pname:commandBuffer was allocated must: not have been created with a
    slink:VkCommandPoolCreateInfo that had a
    slink:VkDataGraphProcessingEngineCreateInfoARM structure in its
    pname:pNext chain
