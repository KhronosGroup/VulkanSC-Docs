...
ifdef::VK_EXT_extended_dynamic_state3[]
    and the `apiext:VK_EXT_extended_dynamic_state3` extension is not enabled
    or any of the ename:VK_DYNAMIC_STATE_DEPTH_CLAMP_ENABLE_EXT,
    ename:VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE, or
    ename:VK_DYNAMIC_STATE_POLYGON_MODE_EXT, or
    ename:VK_DYNAMIC_STATE_CULL_MODE, or ename:VK_DYNAMIC_STATE_FRONT_FACE,
    or ename:VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE, or
    ename:VK_DYNAMIC_STATE_DEPTH_BIAS, or ename:VK_DYNAMIC_STATE_LINE_WIDTH
    dynamic states is not set,
endif::VK_EXT_extended_dynamic_state3[]
