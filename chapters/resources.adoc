...
ifdef::VK_EXT_image_compression_control[]
[open,refpage='vkGetImageSubresourceLayout2EXT',desc='Retrieve information about an image subresource',type='protos']
--
:refpage: vkGetImageSubresourceLayout2EXT
...
include::{generated}/api/protos/vkGetImageSubresourceLayout2EXT.adoc[]
  ...
  * pname:device is the logical device that owns the image.
  * pname:image is the image whose layout is being queried.
  * pname:pSubresource is a pointer to a slink:VkImageSubresource2EXT
    structure selecting a specific image for the image subresource.
  * pname:pLayout is a pointer to a slink:VkSubresourceLayout2EXT structure
    in which the layout is returned.

fname:vkGetImageSubresourceLayout2EXT behaves similarly to
...
It is legal to call fname:vkGetImageSubresourceLayout2EXT with a pname:image
created with pname:tiling equal to ename:VK_IMAGE_TILING_OPTIMAL, but the
members of slink:VkSubresourceLayout2EXT::pname:subresourceLayout will have
undefined: values in this case.

[NOTE]
.Note
====
Structures chained from slink:VkImageSubresource2EXT::pname:pNext will also
...
include::{generated}/validity/protos/vkGetImageSubresourceLayout2EXT.adoc[]
--

[open,refpage='VkImageSubresource2EXT',desc='Structure specifying an image subresource',type='structs']
--
The sname:VkImageSubresource2EXT structure is defined as:
...
include::{generated}/validity/structs/VkImageSubresource2EXT.adoc[]
--

[open,refpage='VkSubresourceLayout2EXT',desc='Structure specifying subresource layout',type='structs']
--
Information about the layout of the image subresource is returned in a
...
include::{generated}/validity/structs/VkSubresourceLayout2EXT.adoc[]
--
endif::VK_EXT_image_compression_control[]
...
ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageViewCreateInfo-image-01586]]
    ...
    <<formats-planes-image-aspect,multi-planar aspect masks>>, then
...
Populating the data in the object after allocating and binding memory is
done with commands such as flink:vkCmdBuildMicromapsEXT,
...
****
  * [[VUID-VkImagePlaneMemoryRequirementsInfo-planeAspect-02281]]
    ...
    valid <<formats-planes-image-aspect,multi-planar aspect mask>>
ifdef::VK_EXT_image_drm_format_modifier[]
