...
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance3,VKSC_VERSION_1_0[]
.Valid Usage
****
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance3[]
  ...
  * [[VUID-vkCreateDescriptorSetLayout-support-09582]]
    ...
    flink:vkGetDescriptorSetLayoutSupport must: have returned
    slink:VkDescriptorSetLayoutSupport with pname:support equal to
    ename:VK_TRUE for pname:pCreateInfo

endif::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance3[]
ifdef::VKSC_VERSION_1_0[]
  * [[VUID-vkCreateDescriptorSetLayout-pCreateInfo-05011]]
    pname:pCreateInfo->bindingCount must: be less than or equal to
    <<limits-maxDescriptorSetLayoutBindings,maxDescriptorSetLayoutBindings>>
  * [[VUID-vkCreateDescriptorSetLayout-pCreateInfo-05012]]
    The pname:binding member of each element of pname:pCreateInfo->pBindings
    must: be less than the value of
    slink:VkDeviceObjectReservationCreateInfo::pname:descriptorSetLayoutBindingLimit
    provided when pname:device was created
...
****
endif::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance3,VKSC_VERSION_1_0[]
...
ifdef::VK_KHR_push_descriptor[]
    and the apiext:VK_KHR_push_descriptor extension is not enabled,
endif::VK_KHR_push_descriptor[]
    <<features-pushDescriptor, pname:pushDescriptor>> must: be enabled
endif::VK_COMPUTE_VERSION_1_4[]
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
  ...
  * [[VUID-VkDescriptorSetLayoutCreateInfo-flags-00281]]
    If pname:flags contains
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT, then the
...
ifdef::VK_EXT_mutable_descriptor_type,VK_VALVE_mutable_descriptor_type[]
[open,refpage='VkMutableDescriptorTypeCreateInfoEXT',desc='Structure describing the list of possible active descriptor types for mutable type descriptors',type='structs']
--
...
[open,refpage='VkMutableDescriptorTypeListEXT',desc='Structure describing descriptor types that a given descriptor may mutate to',type='structs']
--
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
  * ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT specifies that
    descriptor sets must: not be allocated using this layout, and
    descriptors are instead pushed by flink:vkCmdPushDescriptorSet.
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
...
ifndef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
[NOTE]
====
...
ifndef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[array.]
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
...
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkDescriptorSetLayoutBinding-descriptorType-12200]]
    If pname:descriptorType is
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, and
    pname:descriptorCount is not `0` and pname:pImmutableSamplers is not
    `NULL`, either each element of pname:pImmutableSamplers must: be a
    sname:VkSampler that enables <<samplers-YCbCr-conversion,sampler {YCbCr}
    conversion>> or none of them enable sampler {YCbCr} conversion
  * [[VUID-VkDescriptorSetLayoutBinding-descriptorType-12215]]
    If pname:descriptorType is ename:VK_DESCRIPTOR_TYPE_SAMPLER, each
    element of pname:pImmutableSamplers must: not be a sname:VkSampler
...
ifdef::VK_EXT_descriptor_buffer[]
  ...
  * [[VUID-VkDescriptorSetLayoutBinding-flags-08006]]
    If slink:VkDescriptorSetLayoutCreateInfo::pname:flags contains
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_EMBEDDED_IMMUTABLE_SAMPLERS_BIT_EXT,
    pname:descriptorCount must: be less than or equal to `1`
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
[open,refpage='VkDescriptorSetLayoutBindingFlagsCreateInfo',desc='Structure specifying creation flags for descriptor set layout bindings',type='structs']
--
...
ifdef::VK_ARM_tensors[]
  * [[VUID-VkDescriptorSetLayoutBindingFlagsCreateInfo-descriptorBindingStorageTensorUpdateAfterBind-09697]]
    If
    slink:VkPhysicalDeviceTensorFeaturesARM::pname:descriptorBindingStorageTensorUpdateAfterBind
    is not enabled, all bindings with descriptor type
    ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM must: not use
    ename:VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT
endif::VK_ARM_tensors[]
****
...
[open,refpage='VkDescriptorBindingFlagBits',desc='Bitmask specifying descriptor set layout binding properties',type='enums']
--
...
:maxTotalSize: <<limits-maxInlineUniformTotalSize, pname:maxInlineUniformTotalSize>>
  ...
  * ename:VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT specifies that if
...
ifdef::VK_KHR_descriptor_update_template[]
  ...
  * ename:VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT specifies that
  ...
  * ename:VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT specifies
...
ifdef::VK_KHR_descriptor_update_template[]
    ...
    any shader invocations.
  * ename:VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT specifies that
...
ifndef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[counted.]
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
...
ifdef::VK_COMPUTE_VERSION_1_3+VK_EXT_inline_uniform_block[{maxBlockSize} and {maxTotalSize} limits]
ifndef::VK_COMPUTE_VERSION_1_3[{maxBlockSize} limit]
...
[open,refpage='VkDescriptorBindingFlags',desc='Bitmask of VkDescriptorBindingFlagBits',type='flags']
--
...
[NOTE]
====
This command does not take into account the object reservation specified in
slink:VkDeviceObjectReservationCreateInfo when pname:device was created.
In particular, pname:supported is independent of:

  * slink:VkDeviceObjectReservationCreateInfo::pname:descriptorSetLayoutBindingLimit;
  * the
    slink:VkDeviceObjectReservationCreateInfo::pname:descriptorSetLayoutRequestCount
    and
    slink:VkDeviceObjectReservationCreateInfo::pname:descriptorSetLayoutBindingRequestCount
    budgets; and
  * the number of descriptor set layouts and descriptor set layout bindings
    currently allocated from pname:device.

These constraints are only enforced when a descriptor set layout is created
with flink:vkCreateDescriptorSetLayout.
Consequently, pname:supported equal to ename:VK_TRUE indicates that the
implementation is capable of creating the descriptor set layout, but
creating it with flink:vkCreateDescriptorSetLayout can still violate valid
usage on a particular pname:device subject to that device's object
reservation.
====
endif::VKSC_VERSION_1_0[]
...
pname:supported will be ename:VK_TRUE if the descriptor set can: be created,
or else ename:VK_FALSE.
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
[open,refpage='VkDescriptorSetVariableDescriptorCountLayoutSupport',desc='Structure returning information about whether a descriptor set layout can be supported',type='structs']
--
...
pname:maxVariableDescriptorCount is the maximum size of that descriptor that
...
slink:VkPhysicalDeviceDescriptorIndexingFeatures::pname:descriptorBindingVariableDescriptorCount
feature is not enabled, then pname:maxVariableDescriptorCount is zero.
...
of
ifndef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[one,]
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03022]]
    ...
    a pname:descriptorType of ename:VK_DESCRIPTOR_TYPE_SAMPLER and
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER accessible to any given
    shader stage across all elements of pname:pSetLayouts must: be less than
    or equal to
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03023]]
    ...
    feature is supported on the device, the total number of descriptors with
    a pname:descriptorType of ename:VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03024]]
    ...
    feature is supported on the device, the total number of descriptors with
    a pname:descriptorType of ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03026]]
    ...
    feature is supported on the device, the total number of descriptors with
    a pname:descriptorType of ename:VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03027]]
    If any element of pname:pSetLayouts is created with the
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT bit
    set, the total number of descriptors with a pname:descriptorType of
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-02215]]
    If the
    <<features-descriptorBindingInlineUniformBlockUpdateAfterBind,pname:descriptorBindingInlineUniformBlockUpdateAfterBind>>
    feature is supported on the device, the total number of bindings with a
    pname:descriptorType of ename:VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK
    accessible to any given shader stage across all elements of
    pname:pSetLayouts must: be less than or equal to
...
ifdef::VK_KHR_maintenance7[]
    If the <<features-maintenance7, pname:maintenance7>> feature is not
    enabled, the
endif::VK_KHR_maintenance7[]
ifndef::VK_KHR_maintenance7[The]
...
ifdef::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-maintenance7-10003]]
    If the <<features-maintenance7, pname:maintenance7>> feature is enabled,
    the total number of descriptors in descriptor set layouts
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    created without the
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT bit set
    ...
    ename:VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to <<limits-maxDescriptorSetTotalUniformBuffersDynamic,
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetTotalUniformBuffersDynamic>>
endif::VK_KHR_maintenance7[]
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to <<limits-maxDescriptorSetTotalStorageBuffersDynamic,
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetTotalStorageBuffersDynamic>>
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to <<limits-maxDescriptorSetTotalBuffersDynamic,
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetTotalBuffersDynamic>>
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-10006]]
    ...
    the type ename:VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC or
    ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
    <<limits-maxDescriptorSetUpdateAfterBindTotalBuffersDynamic,
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetUpdateAfterBindTotalBuffersDynamic>>
endif::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
endif::VK_KHR_maintenance7[]
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03036]]
    ...
    <<features-descriptorBindingSampledImageUpdateAfterBind,pname:descriptorBindingSampledImageUpdateAfterBind>>
    feature is supported on the device, the total number of descriptors of
    the type ename:VK_DESCRIPTOR_TYPE_SAMPLER and
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03037]]
    ...
    <<features-descriptorBindingUniformBufferUpdateAfterBind,pname:descriptorBindingUniformBufferUpdateAfterBind>>
    feature is supported on the device, the total number of descriptors of
    the type ename:VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
...
ifdef::VK_KHR_maintenance7[]
    and if the <<features-maintenance7, pname:maintenance7>> feature is not
    enabled,
endif::VK_KHR_maintenance7[]
    ...
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetUpdateAfterBindUniformBuffersDynamic
ifdef::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-maintenance7-10007]]
    If the
    <<features-descriptorBindingUniformBufferUpdateAfterBind,pname:descriptorBindingUniformBufferUpdateAfterBind>>
    feature is supported on the device, and the <<features-maintenance7,
    pname:maintenance7>> feature is enabled, the total number of descriptors
    of the type ename:VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC accessible
    across all shader stages and across all elements of pname:pSetLayouts
    must: be less than or equal to
    <<limits-maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic,
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic>>
endif::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03039]]
    If the
    <<features-descriptorBindingStorageBufferUpdateAfterBind,pname:descriptorBindingStorageBufferUpdateAfterBind>>
    feature is supported on the device, the total number of descriptors of
    the type ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
...
ifdef::VK_KHR_maintenance7[]
    ...
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetUpdateAfterBindStorageBuffersDynamic
ifdef::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-maintenance7-10008]]
    If the
    <<features-descriptorBindingStorageBufferUpdateAfterBind,pname:descriptorBindingStorageBufferUpdateAfterBind>>
    feature is supported on the device, and if the <<features-maintenance7,
    pname:maintenance7>> feature is enabled, the total number of descriptors
    of the type ename:VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC accessible
    across all shader stages and across all elements of pname:pSetLayouts
    must: be less than or equal to
    <<limits-maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic,
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic>>
endif::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03041]]
    If the
    <<features-descriptorBindingSampledImageUpdateAfterBind,pname:descriptorBindingSampledImageUpdateAfterBind>>
    feature is supported on the device, the total number of descriptors of
    the type ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
    ename:VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, and
    ename:VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03042]]
    ...
    <<features-descriptorBindingStorageImageUpdateAfterBind,pname:descriptorBindingStorageImageUpdateAfterBind>>
    feature is supported on the device, the total number of descriptors of
    the type ename:VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, and
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-00293]]
    ...
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT set
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
ifdef::VK_KHR_acceleration_structure[]
...
ifdef::VK_EXT_graphics_pipeline_library[]
    ...
    pname:graphicsPipelineLibrary>> feature is not enabled, elements
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    with a pname:descriptorType of ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM
    accessible to any given shader stage across all elements of
    pname:pSetLayouts must: be less than or equal to
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxPerStageDescriptorSetStorageTensors
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    accessible across all shader stages and across all elements of
    pname:pSetLayouts must: be less than or equal to
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxDescriptorSetStorageTensors
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-09878]]
    The total number of descriptors of the type
    ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM accessible across all shader stages
    and across all elements of pname:pSetLayouts must: be less than or equal
    to
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxDescriptorSetUpdateAfterBindStorageTensors
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-09879]]
    The total number of descriptors with a pname:descriptorType of
    ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM accessible to any given shader stage
    across all elements of pname:pSetLayouts must: be less than or equal to
    sname:VkPhysicalDeviceTensorPropertiesARM::pname:maxPerStageDescriptorUpdateAfterBindStorageTensors
endif::VK_ARM_tensors[]
ifdef::VK_EXT_graphics_pipeline_library+VK_KHR_maintenance11[]
  * [[VUID-VkPipelineLayoutCreateInfo-flags-13352]]
    If pname:flags has
    ename:VK_PIPELINE_LAYOUT_CREATE_NO_TASK_SHADER_BIT_KHR set, then
    ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT must: also be
    set
endif::VK_EXT_graphics_pipeline_library+VK_KHR_maintenance11[]
****
...
ifdef::VK_KHR_maintenance11[]
  * ename:VK_PIPELINE_LAYOUT_CREATE_NO_TASK_SHADER_BIT_KHR, when used in
    combination with
    ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT, specifies that
    this pipeline layout will only be used to draw with shader objects
    created with ename:VK_SHADER_CREATE_NO_TASK_SHADER_BIT_EXT.
...
(see <<pipelines, Pipelines>>), as part of binding descriptor sets (see
<<descriptors-binding, Descriptor Set Binding>>), and as part of setting
push constants (see <<descriptors-push-constants, Push Constant Updates>>).
...
[[descriptors-pipelinelayout-consistency]]
...
shown in <<descriptors-pipelinelayout-limits, Pipeline Layout Resource
Limits>>.
...
[[descriptors-pipelinelayout-limits]]
...
ifdef::VK_KHR_maintenance7[]
or pname:maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic
endif::VK_KHR_maintenance7[]
...
ifdef::VK_KHR_maintenance7[]
or pname:maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic
endif::VK_KHR_maintenance7[]
...
ifdef::VK_ARM_tensors[]
| pname:maxDescriptorSetStorageTensors
or pname:maxDescriptorSetUpdateAfterBindStorageTensors
            | storage tensor
endif::VK_ARM_tensors[]
|====
...
<<descriptors-push-constants, push constants>>`" if they were created with
identical push constant ranges.
Two pipeline layouts are defined to be "`compatible for set N`" if they were
created with <<glossary-identically-defined,identically defined>> descriptor
...
When binding a descriptor set (see <<descriptors-binding, Descriptor Set
...
slink:VkMutableDescriptorTypeCreateInfoEXT structure in the pname:pNext
...
ifdef::VK_ARM_data_graph[]
  * [[VUID-VkDescriptorPoolCreateInfo-pNext-09946]]
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
[open,refpage='VkDescriptorPoolInlineUniformBlockCreateInfo',desc='Structure specifying the maximum number of inline uniform block bindings of a newly created descriptor pool',type='structs']
--
In order to be able to allocate descriptor sets having
<<descriptors-inlineuniformblock, inline uniform block>> bindings the
...
image samplers of <<formats-multiplanar, multi-planar formats>>, an
application needs to account for non-trivial descriptor consumption when
choosing the pname:descriptorCount value, as indicated by
...
slink:VkPhysicalDeviceMaintenance6Properties::pname:maxCombinedImageSamplerDescriptorCount
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * For descriptor set bindings created with the
    ...
    before the descriptor set is <<descriptors-binding,consumed>>.
...
endif::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance1[]

ifndef::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance2[]
...
endif::VK_COMPUTE_VERSION_1_1,VK_KHR_maintenance2[]
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
[open,refpage='VkDescriptorSetVariableDescriptorCountAllocateInfo',desc='Structure specifying additional allocation parameters for descriptor sets',type='structs']
--
...
ifdef::VK_QCOM_image_processing[]
    ...
    or ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER the pname:imageView
...
ifdef::VK_ARM_tensors[]
  * [[VUID-vkUpdateDescriptorSets-pDescriptorWrites-12324]]
    For each element [eq]#i# where
    pname:pDescriptorWrites[i].pname:descriptorType is
    ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM, elements of the pname:pTensorViews
    member of a slink:VkWriteDescriptorSetTensorARM structure in the
    pname:pNext chain of pname:pDescriptorWrites[i] must: have been created
    on pname:device
endif::VK_ARM_tensors[]
...
ifdef::VK_KHR_acceleration_structure[slink:VkWriteDescriptorSetAccelerationStructureKHR]
ifdef::VK_NV_ray_tracing+VK_KHR_acceleration_structure[or]
ifdef::VK_NV_ray_tracing[slink:VkWriteDescriptorSetAccelerationStructureNV]
     structure in the pname:pNext chain
endif::VK_NV_ray_tracing,VK_KHR_acceleration_structure[]
ifdef::VK_ARM_tensors[]
  ** a value matching the pname:descriptorCount of a
     slink:VkWriteDescriptorSetTensorARM structure in the pname:pNext chain
endif::VK_ARM_tensors[]
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
When updating descriptor sets with a pname:descriptorType of
...
ifdef::VK_ARM_tensors[]
When updating descriptor sets with a pname:descriptorType of
ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM, none of the pname:pImageInfo,
pname:pBufferInfo, or pname:pTexelBufferView members are accessed, instead
the source data of the descriptor update operation is taken from the
instance of slink:VkWriteDescriptorSetTensorARM in the pname:pNext chain of
...
[[descriptors-sets-updates-consecutive]]
[float]
...
****
  ...
  * [[VUID-VkWriteDescriptorSet-descriptorCount-00317]]
    ...
    identical pname:descriptorType
  * [[VUID-VkWriteDescriptorSet-descriptorCount-10776]]
    All consecutive bindings updated via a single sname:VkWriteDescriptorSet
    structure, except those with a pname:descriptorCount of zero, must: have
    identical pname:stageFlags
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkWriteDescriptorSet-descriptorCount-10777]]
    All consecutive bindings updated via a single sname:VkWriteDescriptorSet
    structure, except those with a pname:descriptorCount of zero, must: have
  ...
  * [[VUID-VkWriteDescriptorSet-dstArrayElement-00321]]
    ...
    <<descriptors-sets-updates-consecutive, consecutive bindings>>
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
...
ifdef::VK_QCOM_image_processing[]
    ...
    ename:VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT, then the pname:imageView
    member of each element of pname:pImageInfo must: not be
    dlink:VK_NULL_HANDLE
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
...
ifdef::VK_ARM_tensors[]
  * [[VUID-VkWriteDescriptorSet-descriptorType-09945]]
    If pname:descriptorType is ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM, the
    pname:pNext chain must: include a slink:VkWriteDescriptorSetTensorARM
    structure whose pname:tensorViewCount member equals
    pname:descriptorCount
endif::VK_ARM_tensors[]
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  ...
  * [[VUID-VkWriteDescriptorSet-descriptorType-01948]]
    ...
    pname:pNext chain with an <<glossary-identically-defined,identically
    defined>> sname:VkSamplerYcbcrConversionInfo to the corresponding
    immutable sampler
  ...
  * [[VUID-VkWriteDescriptorSet-descriptorType-00330]]
    ...
    of each element of pname:pBufferInfo must: have been created with the
...
ifdef::VK_EXT_shader_64bit_indexing[]
    and the <<features-shader64BitIndexing, pname:shader64BitIndexing>>
    feature is not enabled,
endif::VK_EXT_shader_64bit_indexing[]
    the pname:range member of each element of pname:pBufferInfo, or the
    <<buffer-info-effective-range,effective range>> if pname:range is
    ename:VK_WHOLE_SIZE, must: be less than or equal to
  ...
  * [[VUID-VkWriteDescriptorSet-descriptorType-00337]]
    ...
    the ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flag set
  * [[VUID-VkWriteDescriptorSet-descriptorType-04149]]
    ...
    member of the list given in <<descriptors-sampledimage, Sampled Image>>
  ...
  * [[VUID-VkWriteDescriptorSet-descriptorType-00339]]
    ...
    been created with the ename:VK_IMAGE_USAGE_STORAGE_BIT usage flag set
...
ifdef::VK_QCOM_image_processing[]
  * [[VUID-VkWriteDescriptorSet-descriptorType-06942]]
    ...
    member of each element of pname:pImageInfo must: have been created with
    a view created with an pname:image created with the
    ename:VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM usage flag set
  * [[VUID-VkWriteDescriptorSet-descriptorType-06943]]
    If pname:descriptorType is
    ename:VK_DESCRIPTOR_TYPE_BLOCK_MATCH_IMAGE_QCOM, the pname:imageView
    member of each element of pname:pImageInfo must: have been created with
    a view created with an pname:image created with the
    ename:VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM usage flag set
endif::VK_QCOM_image_processing[]
...
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkDescriptorImageInfo-sampler-01564]]
    ...
    <<formats-multiplanar, multi-planar format>>, the image must: have been
    created with ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT, and the
    pname:aspectMask of the pname:imageView must: be a valid
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
[open,refpage='VkWriteDescriptorSetInlineUniformBlock',desc='Structure specifying inline uniform block data',type='structs']
--
...
[open,refpage='VkWriteDescriptorSetPartitionedAccelerationStructureNV',desc='Structure specifying descriptor for PTLAS',type='structs']
--
:refpage: VkWriteDescriptorSetPartitionedAccelerationStructureNV

If the pname:descriptorType member of slink:VkWriteDescriptorSet is
ename:VK_DESCRIPTOR_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_NV, then the
data to write to the descriptor set is specified through a
sname:VkWriteDescriptorSetPartitionedAccelerationStructureNV structure
included in the pname:pNext chain of sname:VkWriteDescriptorSet.

The sname:VkWriteDescriptorSetPartitionedAccelerationStructureNV structure
is defined as:

include::{generated}/api/structs/VkWriteDescriptorSetPartitionedAccelerationStructureNV.adoc[]
  ...
  * pname:accelerationStructureCount is the number of elements in
    pname:pAccelerationStructures.
  * pname:pAccelerationStructures is a pointer to an array of
    pname:accelerationStructureCount device addresses pointing to previously
    built PTLAS.
...
****
  ...
  * [[VUID-VkWriteDescriptorSetPartitionedAccelerationStructureNV-pAccelerationStructures-10512]]
    Each entry in pname:pAccelerationStructures must: be a valid address of
    a PTLAS
****

include::{generated}/validity/structs/VkWriteDescriptorSetPartitionedAccelerationStructureNV.adoc[]
--
...
ifdef::VK_ARM_tensors[]
[open,refpage='VkWriteDescriptorSetTensorARM',desc='Structure specifying descriptor tensor info',type='structs']
--
The sname:VkWriteDescriptorSetTensorARM structure is defined as:

include::{generated}/api/structs/VkWriteDescriptorSetTensorARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:tensorViewCount is the number of elements in pname:pTensorViews.
  * pname:pTensorViews are the tensor views that will be used to update the
    descriptor set.
...
ifdef::VK_EXT_robustness2[]
  * [[VUID-VkWriteDescriptorSetTensorARM-nullDescriptor-09898]]
    If the <<features-nullDescriptor, pname:nullDescriptor>> feature is not
    enabled, each element of pname:pTensorViews must: not be
    dlink:VK_NULL_HANDLE
endif::VK_EXT_robustness2[]
****

include::{generated}/validity/structs/VkWriteDescriptorSetTensorARM.adoc[]
--
endif::VK_ARM_tensors[]
...
****
  ...
  * [[VUID-VkCopyDescriptorSet-srcSet-00349]]
    ...
    may: include array elements from <<descriptors-sets-updates-consecutive,
...
// tag::scremoved[]
  ...
  ** ename:VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS <<SCID-8>>
// end::scremoved[]
endif::hidden[]
endif::VKSC_VERSION_1_0[]
...
[[descriptors-sets-updates-with-template]]
...
format.
In conjunction with
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[flink:vkCmdPushDescriptorSetWithTemplate or]
flink:vkUpdateDescriptorSetWithTemplate, this can: be more efficient
compared to calling
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[flink:vkCmdPushDescriptorSet or]
flink:vkUpdateDescriptorSets.
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
    If set to ename:VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS it
...
****
  * [[VUID-VkDescriptorUpdateTemplateCreateInfo-templateType-00350]]
    ...
    handle
ifdef::VK_COMPUTE_VERSION_1_4[]
  * [[VUID-VkDescriptorUpdateTemplateCreateInfo-templateType-10355]]
    If pname:templateType is
    ename:VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS,
ifdef::VK_KHR_push_descriptor[]
    and the apiext:VK_KHR_push_descriptor extension is not enabled,
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
  ...
  * [[VUID-VkDescriptorUpdateTemplateCreateInfo-templateType-00353]]
    If pname:templateType is
    ename:VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS, pname:set
...
include::{generated}/api/enums/VkDescriptorUpdateTemplateTypeKHR.adoc[]
  ...
  * ename:VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_DESCRIPTOR_SET specifies that
    ...
    only.
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_push_descriptor[]
  * ename:VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS specifies that
...
****
  ...
  * [[VUID-VkDescriptorUpdateTemplateEntry-dstArrayElement-00355]]
    ...
    implicitly specified when using a descriptor update template to update
    descriptors, and all applicable <<descriptors-sets-updates-consecutive,
    consecutive bindings>>
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
...
****
  * [[VUID-vkUpdateDescriptorSetWithTemplate-pData-01685]]
    ...
    valid instances of
ifdef::VK_KHR_acceleration_structure[slink:VkAccelerationStructureKHR handles,]
ifdef::VK_NV_ray_tracing[slink:VkAccelerationStructureNV handles,]
    slink:VkDescriptorImageInfo, slink:VkDescriptorBufferInfo, or
    slink:VkBufferView in a layout defined by pname:descriptorUpdateTemplate
    when it was created with flink:vkCreateDescriptorUpdateTemplate
...
described in <<descriptors-compatibility, Pipeline Layout Compatibility>>.
...
A descriptor that was disturbed by <<descriptors-compatibility, Pipeline
Layout Compatibility>>, or was never bound by fname:vkCmdBindDescriptorSets
is not considered valid.
For any given descriptor, elink:VkDescriptorBindingFlagBits and
elink:VkDescriptorSetLayoutCreateFlagBits determine if validity is defined
...
elink:VkDescriptorType in slink:VkDescriptorSetLayoutCreateInfo for the
...
[[descriptors-binding-dynamicoffsets]]
...
<<descriptors-compatibility, Pipeline Layout Compatibility>> section.
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='vkCmdBindDescriptorSets2',desc='Binds descriptor sets to a command buffer',type='protos']
--
:refpage: vkCmdBindDescriptorSets2

To bind one or more descriptor sets to a command buffer, call:

ifdef::VK_COMPUTE_VERSION_1_4[]
include::{generated}/api/protos/vkCmdBindDescriptorSets2.adoc[]
endif::VK_COMPUTE_VERSION_1_4[]
...
include::{generated}/api/protos/vkCmdBindDescriptorSets2KHR.adoc[]
  ...
  * pname:pBindDescriptorSetsInfo is a pointer to a
    sname:VkBindDescriptorSetsInfo structure.
...
include::{generated}/validity/protos/vkCmdBindDescriptorSets2.adoc[]
--

[open,refpage='VkBindDescriptorSetsInfo',desc='Structure specifying a descriptor set binding operation',type='structs']
--
:refpage: VkBindDescriptorSetsInfo

The sname:VkBindDescriptorSetsInfo structure is defined as:

include::{generated}/api/structs/VkBindDescriptorSetsInfo.adoc[]
...
include::{generated}/validity/structs/VkBindDescriptorSetsInfo.adoc[]
--
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
...
[open,refpage='vkCmdPushDescriptorSet',desc='Pushes descriptor updates into a command buffer',type='protos']
--
:refpage: vkCmdPushDescriptorSet

To push descriptor updates into a command buffer, call:

ifdef::VK_COMPUTE_VERSION_1_4[]
include::{generated}/api/protos/vkCmdPushDescriptorSet.adoc[]
endif::VK_COMPUTE_VERSION_1_4[]
...
include::{chapters}/commonvalidity/push_descriptor_set_common.adoc[]
  * [[VUID-vkCmdPushDescriptorSet-pipelineBindPoint-00363]]
    ...
    parent sname:VkCommandPool's queue family
ifdef::VK_COMPUTE_VERSION_1_4[]
  * [[VUID-vkCmdPushDescriptorSet-None-10356]]
    {empty}
ifdef::VK_KHR_push_descriptor[]
    If the apiext:VK_KHR_push_descriptor extension is not enabled,
endif::VK_KHR_push_descriptor[]
    <<features-pushDescriptor, pname:pushDescriptor>> must: be enabled
endif::VK_COMPUTE_VERSION_1_4[]
****

include::{generated}/validity/protos/vkCmdPushDescriptorSet.adoc[]
--

ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='vkCmdPushDescriptorSet2',desc='Pushes descriptor updates into a command buffer',type='protos']
--
:refpage: vkCmdPushDescriptorSet2

To push descriptor updates into a command buffer, call:

ifdef::VK_COMPUTE_VERSION_1_4[]
include::{generated}/api/protos/vkCmdPushDescriptorSet2.adoc[]
endif::VK_COMPUTE_VERSION_1_4[]
...
include::{generated}/api/protos/vkCmdPushDescriptorSet2KHR.adoc[]
  ...
  * pname:pPushDescriptorSetInfo is a pointer to a
    sname:VkPushDescriptorSetInfo structure.
...
include::{generated}/validity/protos/vkCmdPushDescriptorSet2.adoc[]
--

[open,refpage='VkPushDescriptorSetInfo',desc='Structure specifying a descriptor set push operation',type='structs']
--
:refpage: VkPushDescriptorSetInfo

The sname:VkPushDescriptorSetInfo structure is defined as:

include::{generated}/api/structs/VkPushDescriptorSetInfo.adoc[]
...
include::{generated}/validity/structs/VkPushDescriptorSetInfo.adoc[]
--
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
...
[open,refpage='vkCmdPushDescriptorSetWithTemplate',desc='Pushes descriptor updates into a command buffer using a descriptor update template',type='protos']
--
:refpage: vkCmdPushDescriptorSetWithTemplate

To use a descriptor update template to specify the push descriptors to
update in a command buffer, call:

ifdef::VK_COMPUTE_VERSION_1_4[]
include::{generated}/api/protos/vkCmdPushDescriptorSetWithTemplate.adoc[]
endif::VK_COMPUTE_VERSION_1_4[]
...
include::{generated}/validity/protos/vkCmdPushDescriptorSetWithTemplate.adoc[]
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='vkCmdPushDescriptorSetWithTemplate2',desc='Pushes descriptor updates into a command buffer using a descriptor update template',type='protos']
--
:refpage: vkCmdPushDescriptorSetWithTemplate2

To use a descriptor update template to specify the push descriptors to
update in a command buffer, call:

ifdef::VK_COMPUTE_VERSION_1_4[]
include::{generated}/api/protos/vkCmdPushDescriptorSetWithTemplate2.adoc[]
endif::VK_COMPUTE_VERSION_1_4[]
...
include::{generated}/api/protos/vkCmdPushDescriptorSetWithTemplate2KHR.adoc[]
  ...
  * pname:pPushDescriptorSetWithTemplateInfo is a pointer to a
    sname:VkPushDescriptorSetWithTemplateInfo structure.
...
include::{generated}/validity/protos/vkCmdPushDescriptorSetWithTemplate2.adoc[]
--

[open,refpage='VkPushDescriptorSetWithTemplateInfo',desc='Structure specifying a descriptor set push operation using a descriptor update template',type='structs']
--
:refpage: VkPushDescriptorSetWithTemplateInfo

The sname:VkPushDescriptorSetWithTemplateInfo structure is defined as:

include::{generated}/api/structs/VkPushDescriptorSetWithTemplateInfo.adoc[]
...
include::{chapters}/commonvalidity/dynamic_pipeline_layout_common.adoc[]
ifdef::VK_COMPUTE_VERSION_1_4[]
  * [[VUID-VkPushDescriptorSetWithTemplateInfo-None-10359]]
    {empty}
ifdef::VK_KHR_push_descriptor[]
    If the apiext:VK_KHR_push_descriptor extension is not enabled,
endif::VK_KHR_push_descriptor[]
...
include::{generated}/validity/structs/VkPushDescriptorSetWithTemplateInfo.adoc[]
--
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
...
As described above in section <<descriptors-pipelinelayout, Pipeline
...
ranges, as described in <<descriptors-compatibility,Pipeline Layout
Compatibility>>.
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='vkCmdPushConstants2',desc='Update the values of push constants',type='protos']
--
:refpage: vkCmdPushConstants2

To update push constants, call:

ifdef::VK_COMPUTE_VERSION_1_4[]
include::{generated}/api/protos/vkCmdPushConstants2.adoc[]
endif::VK_COMPUTE_VERSION_1_4[]
...
[open,refpage='VkPushConstantsInfo',desc='Structure specifying a push constant update operation',type='structs']
--
:refpage: VkPushConstantsInfo

The sname:VkPushConstantsInfo structure is defined as:

include::{generated}/api/structs/VkPushConstantsInfo.adoc[]
...
include::{generated}/validity/structs/VkPushConstantsInfo.adoc[]
--
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance6[]
